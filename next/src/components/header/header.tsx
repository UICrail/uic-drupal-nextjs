...
import HeaderIcon from "@/styles/icons/uic_logo.svg";
...
export function Header({ menu }: HeaderProps) {
  ...
  return (
    <header className="z-50 flex-shrink-0 border-b border-border bg-background text-primary md:sticky md:top-0">
      <nav className="mx-auto flex max-w-7xl flex-row items-center justify-between px-6 py-4">
        <HomeLink />
...
function HomeLink() {
  ...
  return (
    <LinkWithLocale href="/" className="inline">
      <HeaderIcon className="w-32 pb-2" />
